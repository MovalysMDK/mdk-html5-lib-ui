...
angular.module('mfui').factory('MFValueImageVM', ['MFUtils', 'MFAbstractViewModel',function (MFUtils, MFAbstractViewModel) {
    var MFValueImageVM = function MFValueImageVM() {
        ...
        Object.defineProperties(this, {
            ...
            pictureName: {
                get: function () {
                    ...
                    if(angular.isUndefinedOrNullOrEmpty(_valueAttribute)){
                        return _selectedItem;
                    }else if(angular.isUndefinedOrNullOrEmpty(_selectedItem)){
                        console.log('There is no selected item to this enum Image');
                        return null;
                    }else{
            ...
            pictureURI: {
                get: function () {
                    if(angular.isUndefinedOrNullOrEmpty(this.pictureName)){
                        return _pictureDir+'/nophoto.png';
                    }else{
