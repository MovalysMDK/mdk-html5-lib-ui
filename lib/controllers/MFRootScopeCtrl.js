...
angular.module('mfui').controller('MFRootScopeCtrl', ['$scope', '$q', 'MFRootScopeBuilder', 'MFResetBaseAction', 'MFLoadFileToSessionStorageAction', 'MFDeleteKeySessionStorageAction', 'MFExportBaseAction', 'MFImportBaseAction', 'MFDataToFileAction', 'MFDataFromFileAction', 'MFActionLauncher',
    function($scope, $q, MFRootScopeBuilder, MFResetBaseAction, MFLoadFileToSessionStorageAction, MFDeleteKeySessionStorageAction, MFExportBaseAction, MFImportBaseAction, MFDataToFileAction, MFDataFromFileAction, MFActionLauncher) {
        var params = {
