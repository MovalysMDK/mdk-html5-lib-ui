...
'MFViewScopeBuilder', 'MFGenericLoadDataAction', 'MFActionLauncher', 'MFUpdateVMWithDataLoaderAction', 'MFUtils', 'MFFormModals', 'growl', 'MFConfigurationService', 'snapRemote', 'MFDeviceInfo', '$translate', 'MFCordova', '$anchorScroll', '$location','$rootScope',
function (MFException, $injector, $state, $stateParams, $q, $qSync, MFViewScopeBuilder, MFGenericLoadDataAction, MFActionLauncher, MFUpdateVMWithDataLoaderAction, MFUtils, MFFormModals, growl, MFConfigurationService, snapRemote, MFDeviceInfo, $translate, MFCordova, $anchorScroll, $location, $rootScope) {
