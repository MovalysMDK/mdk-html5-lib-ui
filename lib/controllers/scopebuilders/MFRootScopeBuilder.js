...
angular.module('mfui').factory('MFRootScopeBuilder', ['MFException', '$injector', '$state', '$stateParams', '$q',
    'MFViewScopeBuilder', 'MFGenericLoadDataAction', 'MFActionLauncher', 'MFUpdateVMWithDataLoaderAction', 'MFUtils', 'MFFormModals','growl','MFConfigurationService','snapRemote','MFDeviceInfo','$translate','MFCordova',
    function(MFException, $injector, $state, $stateParams, $q, MFViewScopeBuilder, MFGenericLoadDataAction, MFActionLauncher, MFUpdateVMWithDataLoaderAction, MFUtils, MFFormModals,growl,MFConfigurationService,snapRemote, MFDeviceInfo,$translate,MFCordova) {
...
//  MESSAGES & POPUPS
        ...
        MFCordova.onCordovaReady(
            function available(){
                if(navigator.notification && navigator.notification.alert && MFDeviceInfo.deviceOS !== 'WINDOWS8') {
                    MFRootScopeActions.prototype.showNotification = function (m, interpolateParams, closingTimeout) {
                        var title = '';
                        if (!angular.isUndefinedOrNull(m.title)) {
                            title = m.title;
        ...
        MFRootScopeActions.prototype.goHistoryBack = function(){
        ...
        MFRootScopeActions.prototype.isDisabledModeNonEditable = function() {
            return this.$scope.$screenScope.viewConfig.screenConfig.disabledModeNonEditable;
        };
