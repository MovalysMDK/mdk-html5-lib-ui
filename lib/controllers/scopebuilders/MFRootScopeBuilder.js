...
angular.module('mfui').factory('MFRootScopeBuilder', ['MFException', '$injector', '$state', '$stateParams', '$q',
    ...
    function (MFException, $injector, $state, $stateParams, $q, MFViewScopeBuilder, MFGenericLoadDataAction, MFActionLauncher, MFUpdateVMWithDataLoaderAction, MFUtils, MFFormModals, growl, MFConfigurationService, snapRemote, MFDeviceInfo, $translate, MFCordova,$anchorScroll,$location) {
