...
angular.module('mfui').factory('MFRootScopeBuilder', ['MFException', '$injector', '$state', '$stateParams', '$q',
    'MFViewScopeBuilder', 'MFGenericLoadDataAction', 'MFActionLauncher', 'MFUpdateVMWithDataLoaderAction', 'MFUtils', 'MFFormModals','growl','MFConfigurationService','snapRemote',
    function(MFException, $injector, $state, $stateParams, $q, MFViewScopeBuilder, MFGenericLoadDataAction, MFActionLauncher, MFUpdateVMWithDataLoaderAction, MFUtils, MFFormModals,growl,MFConfigurationService,snapRemote) {
...
//  MESSAGES & POPUPS
        ...
        MFRootScopeActions.prototype.showNotification = function (m, interpolateParams, closingTimeout) {
            ...
            if (!angular.isUndefinedOrNullOrEmpty(m.message) ) {
