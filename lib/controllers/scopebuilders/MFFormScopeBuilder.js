        ...
        ['$injector',  '$modal', '$q',
         ...
         function ($injector, $modal, $q,
            ...
            var MFFormScopeActions = function MFFormScopeActions($scope) {
                ...
                $scope.editMode = false || $scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.forceInEditionMode;
          ...
          // Form Edition
            ...
            MFFormScopeActions.prototype.goOutEditionMode = function() {
                if (this.$scope.editMode) {
                    // this.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig
                    this.$scope.editMode = false || this.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.forceInEditionMode;
           ...
           // Form Cancellation
            MFFormScopeActions.prototype.cancel = function() {
                if (this.isCancelable()) {
                    ...
                    if (this.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.forceInEditionMode) {
            ...
            MFFormScopeActions.prototype.save = function(silent) {
                ...
                if (!angular.isUndefinedOrNullOrEmpty(this.$scope.viewConfig.saveAction)) {
                    ...
                    if(self.isValid()){
                        ...
                        if (angular.isUndefinedOrNull(silent)) {
                            silent = false;
                        }
            ...
            MFFormScopeActions.prototype.init = function(initListener) {
                ...
                MFFormScopeActions._super.init.call(this, initListener).then(
                    function() {
                        console.assert(!angular.isUndefined(self.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.exitState), '"$scope.viewConfig.screenConfig.exitState" is required in '+self.$scope.rootActions.$scope.$screenScope.viewConfig.viewName);
                        console.assert(!angular.isUndefinedOrNull(self.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.exitOnSave), '"$scope.$screenScope.viewConfig.screenConfig.exitOnSave" is required in '+self.$scope.rootActions.$scope.$screenScope.viewConfig.viewName);
                        console.assert(!angular.isUndefinedOrNull(self.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.exitOnCancel), '"$scope.$screenScope.viewConfig.screenConfig.exitOnCancel" is required in '+self.$scope.rootActions.$scope.$screenScope.viewConfig.viewName);
                        console.assert(!angular.isUndefinedOrNull(self.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.exitWithoutSaving), '"$scope.$screenScope.viewConfig.screenConfig.exitWithoutSaving" is required in '+self.$scope.rootActions.$scope.$screenScope.viewConfig.viewName);
