        ...
        ['$injector',  '$modal', '$q',
         ...
         function ($injector, $modal, $q,
            ...
            var MFFormScopeActions = function MFFormScopeActions($scope) {
                ...
                $scope.editMode = false || $scope.$screenScope.viewConfig.screenConfig.disabledEditionMode;
          ...
          // Form Edition
           ...
           // Form Cancellation
            ...
            MFFormScopeActions.prototype.save = function() {
                ...
                if (!angular.isUndefinedOrNullOrEmpty(this.$scope.viewConfig.saveAction)) {
                    ...
                    if(self.isValid()){
                        ...
                        this.rootActions.showErrorNotification('The form is not valid');
                        deferred.reject();
                    }
                } else {
            ...
            MFFormScopeBuilder.init = function($scope, initListener) {
                ...
                // Call goInEditionMode async wait for the end of the screen loading
                setTimeout(function() {
