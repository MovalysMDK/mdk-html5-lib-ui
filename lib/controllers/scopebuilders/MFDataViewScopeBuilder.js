...
angular.module('mfui').factory('MFDataViewScopeBuilder', [
    ...
    function($injector, $stateParams, $q,
        ...
        MFDataViewScopeActions.prototype.initViewModel = function() {
            try {
                console.log('MFAbstractBindController.createViewModel with ', this.$scope.viewConfig.dataLoader);
        ...
        MFDataViewScopeActions.prototype.doFillAction = function() {
            ...
            var self = this;
            console.assert(!angular.isUndefinedOrNull(this.$scope.viewConfig.dataLoader), '"$scope.viewConfig.dataLoader" is required in '+this.$scope.viewConfig.formName);
            ...
            try {
                ...
                console.log('MFDataViewScopeBuilder.doFillAction - dataLoaderName: ', this.$scope.viewConfig.dataLoader);
