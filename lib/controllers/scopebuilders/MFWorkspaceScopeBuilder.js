    ...
    function($injector, $q, $state, $stateParams, $location, $anchorScroll,
        ...
        MFWorkspaceScopeActions.prototype.goOutEditionMode = function() {
            if (this.$scope.editMode) {
                ...
                this.$scope.editMode = false || this.$scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.disabledEditionMode;
            }
        };

        MFWorkspaceScopeActions.prototype.save = function(silent) {
            ...
            if (!angular.isUndefinedOrNullOrEmpty(this.$scope.viewConfig.saveAction)) {
                ...
                if(self.isValid()){
                    ...
                    MFActionLauncher.launchActions([{ action: action, params: {}}], !silent, false).then(function (context) {
