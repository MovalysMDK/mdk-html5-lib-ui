            ...
            compile: function compile(tElement, tAttrs, transclude) {
                return {
                    pre: function preLink(scope, iElement, iAttrs, formController) {
                        ...
                        scope.getCssClassesContainer = MFDirectivesHelper.getCssClassesContainer(iAttrs.mfCssClassContainer), iAttrs;
                        ...
                        //Manage the value of viewModel of parent scope
//                        scope.mfValue = scope.$parent[iAttrs.mfViewModel][iAttrs.mfField];
//                        scope.$watch(iAttrs.mfField, function() {
//                            scope.$parent[iAttrs.mfViewModel][iAttrs.mfField] = scope.mfValue;
//                        });
