    ...
    function link(scope, element, attrs, ngModelController) {
        ngModelController.$parsers.unshift(function (viewValue) {
            if (scope.mfValidation === true) {
                ...
                ngModelController.$invalid = angular.isUndefinedOrNull(valid) ? false : true ;
                ngModelController.$valid = !ngModelController.$invalid;
                ngModelController.$error = angular.isUndefinedOrNull(valid) ? {} : {invalid: true};
