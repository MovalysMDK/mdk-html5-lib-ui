        ...
        return {
            ...
            controller: function controller($scope, $attrs) {
                ...
                $scope.controlbar.getTitleText = function () {
                    if ($scope.controlBarEnabled && $scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.controlBarTitle !== undefined) {
                        return $scope.rootActions.$scope.$screenScope.viewConfig.screenConfig.controlBarTitle;
                    } else {
                        return $scope.controlbar.defaultTitle;
                    }
                };

                //hidden the controlbar title for xs devices if $scope.rootActions.$scope.$screenScope.viewConfig.hideControlBarTitle
