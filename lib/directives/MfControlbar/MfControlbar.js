        ...
        return {
            ...
            controller: function controller($scope, $attrs) {
                ...
                $scope.controlbar.buttonRemove = function () {
                    return ($scope.controlBarEnabled && $scope.rootActions.isRemovable() && !$scope.rootActions.isInEditionMode()) || ($scope.rootActions.isEditable() && $scope.rootActions.isForceInEditionMode());
                };
                ...
                $scope.controlbar.status = {
                    isopen: false
                };
                $scope.toggleSnap = function () {
                    var snapper = new Snap({
                        element: document.getElementById('mdk-id-flex-container'),
                    });
