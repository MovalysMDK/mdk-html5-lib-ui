    ...
    return {
        ...
        controller: function controller($scope, $attrs){
            ...
            $scope.controlbar.buttonSave = function () {
                return ($scope.controlBarEnabled && $scope.rootActions.isInEditionMode() && $scope.rootActions.isEditable()) || ($scope.rootActions.isEditable() && $scope.rootActions.isDisabledModeNonEditable());
            };
            $scope.controlbar.buttonEdit = function () {
                return $scope.controlBarEnabled && $scope.rootActions.isEditable() && !$scope.rootActions.isInEditionMode() && !$scope.rootActions.isDisabledModeNonEditable();
            };
            $scope.controlbar.buttonCancel = function () {
                return $scope.controlBarEnabled && $scope.rootActions.isInEditionMode() && $scope.rootActions.isCancelable() && !$scope.rootActions.isDisabledModeNonEditable();
            };
            ...
            $scope.controlbar.goBack = function () {
                $scope.rootActions.goHistoryBack();
            };
