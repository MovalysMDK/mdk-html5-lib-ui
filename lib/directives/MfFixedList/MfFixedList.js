...
angular.module('mfui').directive('mfFixedList', ['MFDirectivesHelper', '$modal', '$injector', '$compile', 'MFFormModals', 'MFModalScopeBuilder', '$rootScope',

    function (MFDirectivesHelper, $modal, $injector, $compile, MFFormModals, MFModalScopeBuilder, $rootScope) {
        ...
        return {
            ...
            controller: function controller($scope, $attrs, $element) {
                ...
                // Use scope chain to indicate that child's scope are in fixedList.
                $scope.isFixedList = true;
