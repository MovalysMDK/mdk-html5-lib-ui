    ...
    function(MFDirectivesHelper, $timeout,MFActionOnScroll) {
        ...
        return {
            ...
            controller: function controller($scope, $attrs, $element) {
                ...
                if(!angular.isUndefinedOrNull(MFActionOnScroll.htmlElement)){
            ...
            compile: function compile(tElement, tAttrs, tTransclude) {
                ...
                var template = angular.element(
                        '<snap-content snap-options="opts" id="snap-content" mf-infinite-scroll ng-class="getCssWithControlbar()">'+
